<table class="table table-bordered">
	...
	<tr>
		<td>
		<input class="form-control hidden" id="tenmonhoc<?php echo $i;?>" type="text" value="<?php echo $rowmonhoc["TenMH"]; ?>">
		<strong style="color:#FFF"><?php echo $rowmonhoc["TenMH"]; ?></strong>
		</td>
		<td>
		<input class="form-control" id="diemquatrinh<?php echo $i;?>" type="number" placeholder="Điểm giữa kỳ..." autofocus="autofocus">
	    </td>
		
		<td>
		<input class="form-control" id="diemthi<?php echo $i;?>" type="number" placeholder="Điểm cuối kỳ...">
	    </td>
	</tr>
	<?php $i++; } ?>
</table>
