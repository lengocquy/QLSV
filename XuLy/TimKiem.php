<div class="container">
    <div class="c1">
    	<span class="micon"></span>
            ...
            <span class="titleblack">&nbsp;Tra cứu điểm</span>
    </div>
    <div class="containerpane">
    	<div id="ModuleContent">
			<div style="background:#fff;padding:10px;">
    			<div style="display: block">
    				<form name="frm1" action="./?frame=search" method="post" accept-charset='UTF-8' >
    					<div id="box_search" style="text-align: center;">
                            ...
                            <input type="submit" class="submit-blue"  name ="A"value="Xem bảng điểm cuối kỳ">
    				...
    				<form name="frm2" action="./?frame=search" method="post" accept-charset='UTF-8' >
    					<div style="font-size: 15px; width: 924px; margin: 10px 10px 0 10px" class="clr">
							...
							if(isset($_REQUEST['A']))
							{
								include 'Layout/Table3.php';
							}
    						else if(isset($_REQUEST['masv']))
    						{
    						    include 'Layout/Table2.php';
    						}else include 'Layout/Table.php';
